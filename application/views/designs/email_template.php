...
<style>
	...
	.mhead{font-size:18px; padding-bottom:20px; background-color:#EA0005; padding:15px; margin-bottom:15px; color:#fff; text-align:center; font-weight:bold;}
	...
	.mbtn .btn1{background-color: #EA0005;}
</style>
</head>
...
<body>
	<div id="m_wrap"> 
        <div id="m_box">
            <div class="mhead">
                <div class="mlogo">
                    <img alt="Tehilah Base Digital" src="<?php echo base_url('assets/'); ?>images/logo-3.png" style="max-width:100%;" />
                </div>
				<?php echo $subhead; ?>
            </div>
